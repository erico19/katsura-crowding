  ...
  if (notice_sensors.includes(location)) {
    return (
      <div className="grid gap-4 py-4 mt-16 items-center border-y-2">
        <p className="prose text-base text-gray-800 font-medium">Cafeteria Selene is open for lunch from 11:00 AM to 2:00PM on weekdays and is located at B cluster with; a variety of seating arrangements for both individuals and groups, coupled with a delicately imposing natural scenery which will both relax and inspire you. <a href='https://west2-univ.jp/sp/index.php?t=650120'>See today's menu here.</a></p>
      </div>
    )
  } else if (location == "AMPM18-KJ008") { 
    return (
      <div className="grid gap-2 py-4 mt-16 items-center border-y-2">
        <p className="text-base text-gray-800 font-medium">C Cluster Administration office is the administrative office of C Cluster and is open from 8:30 AM to 5:00 pm. Adjuscent to it, is Cafeteria Soleil which opens for lunch from 11:00 AM to 2:00 PM. The graphical display here shows the general level of busyness at the C Cluster office during the day but may also highlight the general level of busyness at the near by Cafeteria during operational hours.</p>
      </div>
    ) 
